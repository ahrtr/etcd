...
func mustClientCfgFromCmd(cmd *cobra.Command) *clientv3.Config {
	...
	cfg, err := clientv3.NewClientCfg(cc.Endpoints, cc.DialTimeout, cc.KeepAliveTime, cc.KeepAliveTimeout, cc.Scfg, cc.Acfg)
	if err != nil {
...
func secureCfgFromCmd(cmd *cobra.Command) *clientv3.SecureCfg {
...
func authCfgFromCmd(cmd *cobra.Command) *clientv3.AuthCfg {
