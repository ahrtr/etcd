...
func print(lg *zap.Logger, ec Config, sc config.ServerConfig, memberInitialized bool) {
	...
	lg.Info(
		...
		zap.Bool("discovery-insecure-transport", sc.DiscoveryCfg.Scfg.InsecureTransport),
		zap.Bool("discovery-insecure-skip-tls-verify", sc.DiscoveryCfg.Scfg.InsecureSkipVerify),
		zap.String("discovery-cert", sc.DiscoveryCfg.Scfg.Cert),
		zap.String("discovery-key", sc.DiscoveryCfg.Scfg.Key),
		zap.String("discovery-cacert", sc.DiscoveryCfg.Scfg.Cacert),
		zap.String("discovery-user", sc.DiscoveryCfg.Acfg.Username),
